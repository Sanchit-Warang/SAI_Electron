...
import { useEmailThanksLetterMutation } from "@renderer/hooks/api/certificate";
...
const formSchema = z.object({
  ...
  type ThanksLetterEmailFormProps = {
    name: string;
    id: string;
    address: string;
    amount: number;
  ...
  const ThanksLetterSendEmailForm = ({
    name,
    id,
    address,
    amount,
  }: ThanksLetterEmailFormProps) => {
  ...
  export default ThanksLetterSendEmailForm